...
Namespace DateTimeScales
    Partial Public Class Form1
        ...
        Private Sub chartControl1_AxisScaleChanged(ByVal sender As Object, ByVal e As AxisScaleChangedEventArgs) Handles chartControl1.AxisScaleChanged
            ...
            CType(e.Axis, AxisX).Title.Text = "The Axis Grid Alignment Unit is " & e.Axis.DateTimeScaleOptions.GridAlignment.ToString() & ControlChars.CrLf & "The Axis Measure Unit is " & e.Axis.DateTimeScaleOptions.MeasureUnit.ToString()
        End Sub
    End Class
End Namespace
