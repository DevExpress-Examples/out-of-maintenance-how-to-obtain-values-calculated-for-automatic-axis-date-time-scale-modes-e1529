...
namespace DateTimeScales {
    public partial class Form1 : Form {
        ...
        private void chartControl1_AxisScaleChanged(object sender, AxisScaleChangedEventArgs e) {
            ...
            ((AxisX)e.Axis).Title.Text = "The Axis Grid Alignment Unit is " + e.Axis.DateTimeScaleOptions.GridAlignment.ToString() +
                "\r\nThe Axis Measure Unit is " + e.Axis.DateTimeScaleOptions.MeasureUnit.ToString();
        }
    }
}
